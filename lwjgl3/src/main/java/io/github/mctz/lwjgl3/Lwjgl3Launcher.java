package io.github.mctz.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import io.github.mctz.Main;
...
public class Lwjgl3Launcher {
    public static void main(String[] args) {
        ...
        config.setTitle("Civitas <3");
        if (StartupHelper.startNewJvmIfRequired()) return; // T  his handles macOS support and helps on Windows.
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("AlcaldeDigital");
